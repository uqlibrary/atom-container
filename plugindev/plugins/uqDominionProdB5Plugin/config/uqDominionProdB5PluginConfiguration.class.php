...
class uqDominionProdB5PluginConfiguration extends sfPluginConfiguration
{
    ...
    public function initialize()
    {
        ...
        $decoratorDirs[] = sfConfig::get('sf_plugins_dir')
            .'/uqDominionProdB5Plugin/templates';
        ...
        if (false !== $key = array_search('uqDominionProdB5Plugin', $plugins)) {
            unset($plugins[$key]);
        }
        $this->configuration->setPlugins(
            array_merge(['uqDominionProdB5Plugin'], $plugins)
        );
