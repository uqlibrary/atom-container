...
class uqDominionStagingB5PluginConfiguration extends sfPluginConfiguration
{
    ...
    public function initialize()
    {
        ...
        $decoratorDirs[] = sfConfig::get('sf_plugins_dir')
            .'/uqDominionStagingB5Plugin/templates';
        ...
        if (false !== $key = array_search('uqDominionStagingB5Plugin', $plugins)) {
            unset($plugins[$key]);
        }
        $this->configuration->setPlugins(
            array_merge(['uqDominionStagingB5Plugin'], $plugins)
        );
